...
const socials = [
  ...
  {
    label: 'LinkedIn',
    href: 'https://linkedin.com/in/apophia-ronah',
    color: '#0A66C2',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
  ...
  {
    label: 'Instagram',
    href: 'https://instagram.com/apophia_ronah',
    color: '#E1306C',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
...
const CreateMe: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (!validate()) return;
    // Build mailto link so message goes directly to Ronah's email
    const subject = encodeURIComponent(`Portfolio message from ${form.name}`);
    const body = encodeURIComponent(
      `Name: ${form.name}\nEmail: ${form.email}${form.phone ? `\nPhone: ${form.phone}` : ''}\n\nMessage:\n${form.message}`
    );
    window.location.href = `mailto:apophiaron85@gmail.com?subject=${subject}&body=${body}`;
    setSubmitted(true);
      ...
      <div className="contact-me-container">
        <div className="contact-left">
          ...
          <div className="contact-info-list">
            ...
            <a href="mailto:apophiaron85@gmail.com" className="contact-info-item">
              <span className="contact-info-icon">✉️</span>
              <span>apophiaron85@gmail.com</span>
            </a>
            <a href="tel:+250791532685" className="contact-info-item">
              <span className="contact-info-icon">📞</span>
              <span>+250 791 532 685</span>
            </a>
            <a href="sms:+250791532685" className="contact-info-item">
              <span className="contact-info-icon">💬</span>
              <span>Send SMS</span>
            </a>
          </div>
        ...
        <div className="contact-right">
          {submitted ? (
            <div className="contact-success">
              ...
              <h3>Message sent!</h3>
              <p>Thanks for reaching out. Ronah will get back to you soon.</p>
